...
The code above is pretty much boilerplate code. The trickiest part is the client. Ordinarily the Socket.IO client would be a Web browser. In order for us to pipe MIDI data to a Websocket request we’ll need a Socket.IO client. The Socket.IO guys now have an official client called [Socket.IO-client](https://github.com/LearnBoost/socket.io-client).
...
```
See my [previous post](https://audiodestrukt.wordpress.com/2011/12/04/midi-over-http-with-using-alsa-and-curl/) for more details on amidi and finding the correct device number for your MIDI controller.
...
The code for all of this is part of [dub-siren](https://github.com/dnewcome/dub-siren).
