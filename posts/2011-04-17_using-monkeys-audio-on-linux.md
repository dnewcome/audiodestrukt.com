...
**Update**: I now use [X Lossless Decoder](http://tmkk.undo.jp/xld/index_e.html) for extracting .ape files on OSX. It’s nice to have the option of a native decoder.
