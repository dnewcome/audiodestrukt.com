...
I’ve used LTSpice for some of my previous circuit designs, so I set out looking for some vacuum tube models for it. In my search I found the Duncan Amps page, which had a nice simple single-ended EL84 design already done in LTSpice.
