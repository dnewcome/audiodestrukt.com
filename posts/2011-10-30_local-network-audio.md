...
I have been looking around at setting up a JamLAN (I think I just made that up) that could be used to implement a software-based [JamHub](http://www.jamhub.com/). I figured that there would be plenty of ways to get this working on a local network (as opposed to over the Internet), but I was kind of disappointed. 
