...
It’s often a trial by fire to build Pure Data externals despite cross-platform build systems like flext designed to make the job easier. I’ve blogged a little bit about getting some arcane externals to build before, so I’ll continue my quest to document my builds here.
