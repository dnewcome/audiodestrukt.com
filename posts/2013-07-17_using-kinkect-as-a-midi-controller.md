...
I just grabbed a [Microsoft Kinect](http://www.xbox.com/en-US/KINECT) camera from eBay. I’m new to the 3d camera thing so I wanted to get something cheap and simple to start out with.
...
I wanted to do a quick test to make sure everything was working so I grabbed [Gesturement](http://www.gestrument.se/future-development/) and installed it on my Mac.
...
![](images/2013-07-17_using-kinkect-as-a-midi-controller_screen-shot-2013-07-17-at-11-37-54-pm.png)
