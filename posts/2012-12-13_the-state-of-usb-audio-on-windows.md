...
I recently got a new audio interface. I had a cheap Behringer UCA202 USB interface that I had been using for a while and I thought it was time to get something a little nicer. I settled on the PreSonus AudioBox after considering the Focusrite 2i2
...
I used the DPC latency checker as well as LatencyMon to find offending drivers that are doing a lot of interrupts. The top offenders on my system were network interfaces, especially Bluetooth. The second thing that I changed was to make sure that the CPU was always set to run at 100% in the Windows power management console under control panel.
...
Footnotes:
http://www.gearslutz.com/board/low-end-theory/749142-focusrite-scarlett-2i2-vs-presonus-audiobox.html
