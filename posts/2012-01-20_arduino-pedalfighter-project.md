...
I’m looking into building a MIDI foot controller that works something like the [MIDI Fighter](http://midifighter.com/) but for your feet.
...
I’m starting with a cheap prototype using 1/8″ [MDF](http://en.wikipedia.org/wiki/Medium-density_fibreboard) and furring strips. The pushbuttons are general purpose round pushbuttons that are similar to arcade buttons but smaller in diameter. I picked these up locally at [HSC](http://www.halted.com/).
...
```
For some documentation on digitalWrite and enabling the internal pull up resistors see [this page](http://arduino.cc/en/Reference/digitalWrite).
...
![](images/2012-01-20_arduino-pedalfighter-project_ferring-bottom.jpg)
...
![](images/2012-01-20_arduino-pedalfighter-project_messy-hole.jpg)
...
![](images/2012-01-20_arduino-pedalfighter-project_wiring-header.jpg)
...
![](images/2012-01-20_arduino-pedalfighter-project_topside.jpg)
