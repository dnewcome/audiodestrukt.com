...
Some projects have painfully generic names, and https://midieditor.org/ is one of them. I did get this to build from source. It is built on QT5 and uses qmake for building. I got some warnings and the build script didn’t work as-is on my linux box but I got it to work by running qmake by hand and building with make.

I grabbed the source code from here https://github.com/markusschwenk/midieditor
...
There are some commandline tools I’ve been looking at as well like midish https://midish.org/
