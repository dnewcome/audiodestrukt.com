...
![skratchpad](images/2013-02-04_pure-data-skratchpad_skratchpad.png)

I just [released a first version](https://github.com/dnewcome/pd-skratchpad) of a Pure Data patch that I’ve been playing with called Skratchpad. The basic purpose of this patch is to enable manipulation of an audio loop using a turntable and a trigger pad.

Lots of DJs are using things like the [Novation Dicer](http://us.novationmusic.com/digital-dj/dicer) to manipulate cue points and trigger samples. I don’t have a Dicer but I have my [NanoPad](http://www.korg.com/nanoseries2), which I use to trigger things in a similar way.
