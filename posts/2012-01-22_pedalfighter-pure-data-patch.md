...
In a previous post, I described the physical build process for the Pedalfighter project. I have now played around with getting the software setup going using PD.
