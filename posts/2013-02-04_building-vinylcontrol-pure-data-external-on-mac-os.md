...
Vinylcontrol is written using the flext wrappers for PD which allows externals to be written using c++ and built on multiple platforms. The flext system is sort of like autoconf for PD. 
